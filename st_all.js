...
// キーボードの形（多角形方式）
  ...
  'y': { points: [ {x:317 ,y:108 }, {x:317 ,y:96 }, {x:382 ,y:108 }, {x:373 ,y:98 } ]  },
  ...
  'p': { points: [ {x:579 ,y:101 }, { x:551 ,y:101 }, {x:608 ,y:101 }, {x:640 ,y:111 } ]  },
  // 2行目
  ...
  'l': { points: [ {x:504 ,y:100 }, {x:485 ,y:91 }, {x:538 ,y:93 }, {x:538 ,y:93 } ]  },
  // 3行目
  'z': { points: [ {x:93 ,y:87 }, {x:112 ,y:81 }, {x:158 ,y:81 }, {x:145 ,y:88 } ]  },
  'x': { points: [ {x:145 ,y:88 }, {x:158 ,y:81 }, {x:197 ,y:89 }, {x:205 ,y:82 } ]  },
